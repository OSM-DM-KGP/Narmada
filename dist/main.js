...
var map = {
	...
	"./components/components.module": [
		...
		"app-pages-pages-module~components-components-module~maps-maps-module",
		"common",
		"components-components-module"
	],
...
var UserService = /** @class */ (function () {
    function UserService() {
        this.users = {
            nick: { name: 'User', picture: 'assets/images/user.png' },
...
module.exports = ".nb-theme-default :host{width:100%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.nb-theme-default :host .socials{font-size:2rem}.nb-theme-default :host .socials a{padding:0.4rem;color:#a4abb3;-webkit-transition:color ease-out 0.1s;transition:color ease-out 0.1s}.nb-theme-default :host .socials a:hover{color:#2a2a2a}@media (max-width: 575.98px){.nb-theme-default :host .socials{font-size:1.5rem}}.nb-theme-cosmic :host{width:100%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.nb-theme-cosmic :host .socials{font-size:2rem}.nb-theme-cosmic :host .socials a{padding:0.4rem;color:#a1a1e5;-webkit-transition:color ease-out 0.1s;transition:color ease-out 0.1s}.nb-theme-cosmic :host .socials a:hover{color:#fff}@media (max-width: 575.98px){.nb-theme-cosmic :host .socials{font-size:1.5rem}}.nb-theme-corporate :host{width:100%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.nb-theme-corporate :host .socials{font-size:2rem}.nb-theme-corporate :host .socials a{padding:0.4rem;color:#a4abb3;-webkit-transition:color ease-out 0.1s;transition:color ease-out 0.1s}.nb-theme-corporate :host .socials a:hover{color:#181818}@media (max-width: 575.98px){.nb-theme-corporate :host .socials{font-size:1.5rem}}\n"
...
module.exports = ".nb-theme-default :host{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;width:100%}.nb-theme-default :host .left{display:-webkit-box;display:-ms-flexbox;display:flex;width:100%;-webkit-box-ordinal-group:1;-ms-flex-order:0;order:0;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row}.nb-theme-default :host .right{-webkit-box-ordinal-group:2;-ms-flex-order:1;order:1;-webkit-box-orient:horizontal;-webkit-box-direction:reverse;-ms-flex-direction:row-reverse;flex-direction:row-reverse}.nb-theme-default :host .logo-containter{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;width:calc(16rem - 1.25rem)}.nb-theme-default :host .control-item{display:block}.nb-theme-default :host .header-container{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;width:auto}.nb-theme-default :host .header-container .navigation{font-size:2.5rem;text-decoration:none}[dir=ltr] .nb-theme-default :host .header-container .navigation{padding-right:1.25rem}[dir=rtl] .nb-theme-default :host .header-container .navigation{padding-left:1.25rem}.nb-theme-default :host .header-container .navigation i{display:block}.nb-theme-default :host .header-container .logo{padding:0 1.25rem;font-size:1.75rem;font-weight:500;white-space:nowrap}[dir=ltr] .nb-theme-default :host .header-container .logo{border-left:1px solid #ebeef2}[dir=rtl] .nb-theme-default :host .header-container .logo{border-right:1px solid #ebeef2}.nb-theme-default :host .header-container .logo span{font-weight:400}.nb-theme-default :host ngx-layout-direction-switcher{margin:0 1.5rem}.nb-theme-default :host ngx-theme-switcher{margin:2.25rem 2.25rem 0.75rem;margin-top:0;margin-bottom:0}@media (max-width: 1399.98px){.nb-theme-default :host ngx-layout-direction-switcher{display:none}}.nb-theme-default :host .toggle-layout /deep/ a{display:block;text-decoration:none;line-height:1}.nb-theme-default :host .toggle-layout /deep/ a i{color:#40dc7e;font-size:2.25rem;border-radius:50%;position:relative;-webkit-animation-name:pulse-light;animation-name:pulse-light}.nb-theme-default :host .toggle-layout /deep/ a i::after{content:' ';background-image:url(\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\");border-radius:50%;pointer-events:none;position:absolute;top:52.3%;left:50%;-webkit-transform:translate(-50%, -50%);transform:translate(-50%, -50%);width:13%;height:13%;-webkit-animation:3s linear infinite pulse;animation:3s linear infinite pulse;-webkit-animation-name:pulse-light;animation-name:pulse-light}@-webkit-keyframes pulse{0%{-webkit-box-shadow:0 0 1px 0 rgba(64,220,126,0);box-shadow:0 0 1px 0 rgba(64,220,126,0)}20%{-webkit-box-shadow:0 0 3px 10px rgba(64,220,126,0.4);box-shadow:0 0 3px 10px rgba(64,220,126,0.4)}100%{-webkit-box-shadow:0 0 5px 20px rgba(64,220,126,0);box-shadow:0 0 5px 20px rgba(64,220,126,0)}}@keyframes pulse{0%{-webkit-box-shadow:0 0 1px 0 rgba(64,220,126,0);box-shadow:0 0 1px 0 rgba(64,220,126,0)}20%{-webkit-box-shadow:0 0 3px 10px rgba(64,220,126,0.4);box-shadow:0 0 3px 10px rgba(64,220,126,0.4)}100%{-webkit-box-shadow:0 0 5px 20px rgba(64,220,126,0);box-shadow:0 0 5px 20px rgba(64,220,126,0)}}@-webkit-keyframes pulse-light{0%{-webkit-box-shadow:0 0 1px 0 rgba(115,255,208,0);box-shadow:0 0 1px 0 rgba(115,255,208,0)}20%{-webkit-box-shadow:0 0 3px 10px rgba(115,255,208,0.4);box-shadow:0 0 3px 10px rgba(115,255,208,0.4)}100%{-webkit-box-shadow:0 0 5px 20px rgba(115,255,208,0);box-shadow:0 0 5px 20px rgba(115,255,208,0)}}@keyframes pulse-light{0%{-webkit-box-shadow:0 0 1px 0 rgba(115,255,208,0);box-shadow:0 0 1px 0 rgba(115,255,208,0)}20%{-webkit-box-shadow:0 0 3px 10px rgba(115,255,208,0.4);box-shadow:0 0 3px 10px rgba(115,255,208,0.4)}100%{-webkit-box-shadow:0 0 5px 20px rgba(115,255,208,0);box-shadow:0 0 5px 20px rgba(115,255,208,0)}}@media (max-width: 991.98px){.nb-theme-default :host nb-action:not(.toggle-layout){border:none}.nb-theme-default :host .control-item{display:none}.nb-theme-default :host .toggle-layout{padding:0}.nb-theme-default :host ngx-layout-direction-switcher{display:none}.nb-theme-default :host ngx-theme-switcher{margin:0 0.5rem}}@media (max-width: 767.98px){.nb-theme-default :host nb-user /deep/ .user-name{display:none}}@media (max-width: 575.98px){.nb-theme-default :host .header-container .logo{font-size:1.25rem}.nb-theme-default :host .toggle-layout{display:none}.nb-theme-default :host ngx-theme-switcher{display:none}.nb-theme-default :host nb-action:not(.toggle-layout){padding:0}}@media (max-width: 399.98px){.nb-theme-default :host .right /deep/ {display:none}}.nb-theme-cosmic :host{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;width:100%}.nb-theme-cosmic :host .left{display:-webkit-box;display:-ms-flexbox;display:flex;width:100%;-webkit-box-ordinal-group:1;-ms-flex-order:0;order:0;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row}.nb-theme-cosmic :host .right{-webkit-box-ordinal-group:2;-ms-flex-order:1;order:1;-webkit-box-orient:horizontal;-webkit-box-direction:reverse;-ms-flex-direction:row-reverse;flex-direction:row-reverse}.nb-theme-cosmic :host .logo-containter{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;width:calc(16.25rem - 1.25rem)}.nb-theme-cosmic :host .control-item{display:block}.nb-theme-cosmic :host .header-container{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;width:auto}.nb-theme-cosmic :host .header-container .navigation{font-size:2.5rem;text-decoration:none}[dir=ltr] .nb-theme-cosmic :host .header-container .navigation{padding-right:1.25rem}[dir=rtl] .nb-theme-cosmic :host .header-container .navigation{padding-left:1.25rem}.nb-theme-cosmic :host .header-container .navigation i{display:block}.nb-theme-cosmic :host .header-container .logo{padding:0 1.25rem;font-size:1.75rem;font-weight:500;white-space:nowrap}[dir=ltr] .nb-theme-cosmic :host .header-container .logo{border-left:1px solid #342e73}[dir=rtl] .nb-theme-cosmic :host .header-container .logo{border-right:1px solid #342e73}.nb-theme-cosmic :host .header-container .logo span{font-weight:400}.nb-theme-cosmic :host ngx-layout-direction-switcher{margin:0 1.5rem}.nb-theme-cosmic :host ngx-theme-switcher{margin:2.25rem 2.25rem 0.75rem;margin-top:0;margin-bottom:0}@media (max-width: 1399.98px){.nb-theme-cosmic :host ngx-layout-direction-switcher{display:none}}.nb-theme-cosmic :host .toggle-layout /deep/ a{display:block;text-decoration:none;line-height:1}.nb-theme-cosmic :host .toggle-layout /deep/ a i{color:#00f9a6;font-size:2.25rem;border-radius:50%;position:relative;-webkit-animation-name:pulse-light;animation-name:pulse-light}.nb-theme-cosmic :host .toggle-layout /deep/ a i::after{content:' ';background-image:url(\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\");border-radius:50%;pointer-events:none;position:absolute;top:52.3%;left:50%;-webkit-transform:translate(-50%, -50%);transform:translate(-50%, -50%);width:13%;height:13%;-webkit-animation:3s linear infinite pulse;animation:3s linear infinite pulse}@-webkit-keyframes pulse{0%{-webkit-box-shadow:0 0 1px 0 rgba(0,249,166,0);box-shadow:0 0 1px 0 rgba(0,249,166,0)}20%{-webkit-box-shadow:0 0 3px 10px rgba(0,249,166,0.4);box-shadow:0 0 3px 10px rgba(0,249,166,0.4)}100%{-webkit-box-shadow:0 0 5px 20px rgba(0,249,166,0);box-shadow:0 0 5px 20px rgba(0,249,166,0)}}@keyframes pulse{0%{-webkit-box-shadow:0 0 1px 0 rgba(0,249,166,0);box-shadow:0 0 1px 0 rgba(0,249,166,0)}20%{-webkit-box-shadow:0 0 3px 10px rgba(0,249,166,0.4);box-shadow:0 0 3px 10px rgba(0,249,166,0.4)}100%{-webkit-box-shadow:0 0 5px 20px rgba(0,249,166,0);box-shadow:0 0 5px 20px rgba(0,249,166,0)}}@-webkit-keyframes pulse-light{0%{-webkit-box-shadow:0 0 1px 0 rgba(115,255,208,0);box-shadow:0 0 1px 0 rgba(115,255,208,0)}20%{-webkit-box-shadow:0 0 3px 10px rgba(115,255,208,0.4);box-shadow:0 0 3px 10px rgba(115,255,208,0.4)}100%{-webkit-box-shadow:0 0 5px 20px rgba(115,255,208,0);box-shadow:0 0 5px 20px rgba(115,255,208,0)}}@keyframes pulse-light{0%{-webkit-box-shadow:0 0 1px 0 rgba(115,255,208,0);box-shadow:0 0 1px 0 rgba(115,255,208,0)}20%{-webkit-box-shadow:0 0 3px 10px rgba(115,255,208,0.4);box-shadow:0 0 3px 10px rgba(115,255,208,0.4)}100%{-webkit-box-shadow:0 0 5px 20px rgba(115,255,208,0);box-shadow:0 0 5px 20px rgba(115,255,208,0)}}@media (max-width: 991.98px){.nb-theme-cosmic :host nb-action:not(.toggle-layout){border:none}.nb-theme-cosmic :host .control-item{display:none}.nb-theme-cosmic :host .toggle-layout{padding:0}.nb-theme-cosmic :host ngx-layout-direction-switcher{display:none}.nb-theme-cosmic :host ngx-theme-switcher{margin:0 0.5rem}}@media (max-width: 767.98px){.nb-theme-cosmic :host nb-user /deep/ .user-name{display:none}}@media (max-width: 575.98px){.nb-theme-cosmic :host .header-container .logo{font-size:1.25rem}.nb-theme-cosmic :host .toggle-layout{display:none}.nb-theme-cosmic :host ngx-theme-switcher{display:none}.nb-theme-cosmic :host nb-action:not(.toggle-layout){padding:0}}@media (max-width: 399.98px){.nb-theme-cosmic :host .right /deep/ {display:none}}.nb-theme-corporate :host{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;width:100%}.nb-theme-corporate :host .left{display:-webkit-box;display:-ms-flexbox;display:flex;width:100%;-webkit-box-ordinal-group:1;-ms-flex-order:0;order:0;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row}.nb-theme-corporate :host .right{-webkit-box-ordinal-group:2;-ms-flex-order:1;order:1;-webkit-box-orient:horizontal;-webkit-box-direction:reverse;-ms-flex-direction:row-reverse;flex-direction:row-reverse}.nb-theme-corporate :host .logo-containter{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;width:calc(16rem - 1.25rem)}.nb-theme-corporate :host .control-item{display:block}.nb-theme-corporate :host .header-container{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;width:auto}.nb-theme-corporate :host .header-container .navigation{font-size:2.5rem;text-decoration:none}[dir=ltr] .nb-theme-corporate :host .header-container .navigation{padding-right:1.25rem}[dir=rtl] .nb-theme-corporate :host .header-container .navigation{padding-left:1.25rem}.nb-theme-corporate :host .header-container .navigation i{display:block}.nb-theme-corporate :host .header-container .logo{padding:0 1.25rem;font-size:1.75rem;font-weight:500;white-space:nowrap}[dir=ltr] .nb-theme-corporate :host .header-container .logo{border-left:1px solid #cdd5dc}[dir=rtl] .nb-theme-corporate :host .header-container .logo{border-right:1px solid #cdd5dc}.nb-theme-corporate :host .header-container .logo span{font-weight:400}[dir=ltr] .nb-theme-corporate :host nb-action{border-left-color:#3f4550}[dir=rtl] .nb-theme-corporate :host nb-action{border-right-color:#3f4550}[dir=ltr] .nb-theme-corporate :host .header-container .logo{border:none}[dir=rtl] .nb-theme-corporate :host .header-container .logo{border:none}.nb-theme-corporate :host .header-container /deep/ ngx-theme-switcher .dropdown-toggle{color:#fff;background:transparent}.nb-theme-corporate :host ngx-layout-direction-switcher{margin:0 1.5rem}.nb-theme-corporate :host ngx-theme-switcher{margin:2.25rem 2.25rem 0.75rem;margin-top:0;margin-bottom:0}@media (max-width: 1399.98px){.nb-theme-corporate :host ngx-layout-direction-switcher{display:none}}.nb-theme-corporate :host .toggle-layout /deep/ a{display:block;text-decoration:none;line-height:1}.nb-theme-corporate :host .toggle-layout /deep/ a i{color:#a4abb3;font-size:2.25rem;border-radius:50%;position:relative;-webkit-animation-name:pulse-light;animation-name:pulse-light}.nb-theme-corporate :host .toggle-layout /deep/ a i::after{content:' ';background-image:url(\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\");border-radius:50%;pointer-events:none;position:absolute;top:52.3%;left:50%;-webkit-transform:translate(-50%, -50%);transform:translate(-50%, -50%);width:13%;height:13%;-webkit-animation:3s linear infinite pulse;animation:3s linear infinite pulse}@-webkit-keyframes pulse{0%{-webkit-box-shadow:0 0 1px 0 rgba(164,171,179,0);box-shadow:0 0 1px 0 rgba(164,171,179,0)}20%{-webkit-box-shadow:0 0 3px 10px rgba(164,171,179,0.4);box-shadow:0 0 3px 10px rgba(164,171,179,0.4)}100%{-webkit-box-shadow:0 0 5px 20px rgba(164,171,179,0);box-shadow:0 0 5px 20px rgba(164,171,179,0)}}@keyframes pulse{0%{-webkit-box-shadow:0 0 1px 0 rgba(164,171,179,0);box-shadow:0 0 1px 0 rgba(164,171,179,0)}20%{-webkit-box-shadow:0 0 3px 10px rgba(164,171,179,0.4);box-shadow:0 0 3px 10px rgba(164,171,179,0.4)}100%{-webkit-box-shadow:0 0 5px 20px rgba(164,171,179,0);box-shadow:0 0 5px 20px rgba(164,171,179,0)}}@-webkit-keyframes pulse-light{0%{-webkit-box-shadow:0 0 1px 0 rgba(115,255,208,0);box-shadow:0 0 1px 0 rgba(115,255,208,0)}20%{-webkit-box-shadow:0 0 3px 10px rgba(115,255,208,0.4);box-shadow:0 0 3px 10px rgba(115,255,208,0.4)}100%{-webkit-box-shadow:0 0 5px 20px rgba(115,255,208,0);box-shadow:0 0 5px 20px rgba(115,255,208,0)}}@keyframes pulse-light{0%{-webkit-box-shadow:0 0 1px 0 rgba(115,255,208,0);box-shadow:0 0 1px 0 rgba(115,255,208,0)}20%{-webkit-box-shadow:0 0 3px 10px rgba(115,255,208,0.4);box-shadow:0 0 3px 10px rgba(115,255,208,0.4)}100%{-webkit-box-shadow:0 0 5px 20px rgba(115,255,208,0);box-shadow:0 0 5px 20px rgba(115,255,208,0)}}@media (max-width: 991.98px){.nb-theme-corporate :host nb-action:not(.toggle-layout){border:none}.nb-theme-corporate :host .control-item{display:none}.nb-theme-corporate :host .toggle-layout{padding:0}.nb-theme-corporate :host ngx-layout-direction-switcher{display:none}.nb-theme-corporate :host ngx-theme-switcher{margin:0 0.5rem}}@media (max-width: 767.98px){.nb-theme-corporate :host nb-user /deep/ .user-name{display:none}}@media (max-width: 575.98px){.nb-theme-corporate :host .header-container .logo{font-size:1.25rem}.nb-theme-corporate :host .toggle-layout{display:none}.nb-theme-corporate :host ngx-theme-switcher{display:none}.nb-theme-corporate :host nb-action:not(.toggle-layout){padding:0}}@media (max-width: 399.98px){.nb-theme-corporate :host .right /deep/ {display:none}}\n"
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(sidebarService, menuService, userService, analyticsService, layoutService, router) {
    ...
    HeaderComponent.prototype.startSearch = function (key) {
...
module.exports = ":host{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center}:host i.control-icon::before{font-size:2.3rem}:host i.control-icon:hover{cursor:pointer}:host input{border:none;outline:none;margin-left:1rem;width:15rem;-webkit-transition:width 0.2s ease;transition:width 0.2s ease}:host input.hidden{width:0;margin:0}:host /deep/ search-input input{background:transparent}\n"
...
module.exports = ".nb-theme-default :host .switch-label{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-ms-flex-align:center;align-items:center;cursor:pointer;margin:0}.nb-theme-default :host .switch-label.vertical{-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:start;-ms-flex-align:start;align-items:flex-start}.nb-theme-default :host .switch-label.vertical .first,.nb-theme-default :host .switch-label.vertical .second{padding:0}.nb-theme-default :host .switch-label.vertical .switch{margin-top:0.5em}.nb-theme-default :host .switch-label>span{font-size:1.125rem;font-weight:600;-webkit-transition:opacity 0.3s ease;transition:opacity 0.3s ease;color:#a4abb3}[dir=ltr] .nb-theme-default :host .switch-label>span.first{padding-right:10px}[dir=rtl] .nb-theme-default :host .switch-label>span.first{padding-left:10px}[dir=ltr] .nb-theme-default :host .switch-label>span.second{padding-left:10px}[dir=rtl] .nb-theme-default :host .switch-label>span.second{padding-right:10px}.nb-theme-default :host .switch-label>span.active{color:#4b4b4b}.nb-theme-default :host .switch-label>span:active{opacity:0.78}.nb-theme-default :host .switch{position:relative;display:inline-block;width:3rem;height:1.5rem;margin:0}.nb-theme-default :host .switch input{display:none}[dir=ltr] .nb-theme-default :host .switch input:checked+.slider::before{-webkit-transform:translateX(1.5rem);transform:translateX(1.5rem)}[dir=rtl] .nb-theme-default :host .switch input:checked+.slider::before{-webkit-transform:translateX(-1.5rem);transform:translateX(-1.5rem)}.nb-theme-default :host .switch .slider{position:absolute;top:0;left:0;right:0;bottom:0;border-radius:1.75rem;background-color:#ebeff5}.nb-theme-default :host .switch .slider::before{position:absolute;content:'';height:1.5rem;width:1.5rem;border-radius:50%;background-color:#40dc7e;-webkit-transition:0.2s;transition:0.2s;-webkit-box-shadow:0 0 0.25rem 0 rgba(164,171,179,0.4);box-shadow:0 0 0.25rem 0 rgba(164,171,179,0.4)}@media (max-width: 399.98px){.nb-theme-default :host{-webkit-box-align:end;-ms-flex-align:end;align-items:flex-end}}.nb-theme-cosmic :host .switch-label{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-ms-flex-align:center;align-items:center;cursor:pointer;margin:0}.nb-theme-cosmic :host .switch-label.vertical{-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:start;-ms-flex-align:start;align-items:flex-start}.nb-theme-cosmic :host .switch-label.vertical .first,.nb-theme-cosmic :host .switch-label.vertical .second{padding:0}.nb-theme-cosmic :host .switch-label.vertical .switch{margin-top:0.5em}.nb-theme-cosmic :host .switch-label>span{font-size:1.125rem;font-weight:600;-webkit-transition:opacity 0.3s ease;transition:opacity 0.3s ease;color:#a1a1e5;color:#a1a1e5}[dir=ltr] .nb-theme-cosmic :host .switch-label>span.first{padding-right:10px}[dir=rtl] .nb-theme-cosmic :host .switch-label>span.first{padding-left:10px}[dir=ltr] .nb-theme-cosmic :host .switch-label>span.second{padding-left:10px}[dir=rtl] .nb-theme-cosmic :host .switch-label>span.second{padding-right:10px}.nb-theme-cosmic :host .switch-label>span.active{color:#d1d1ff}.nb-theme-cosmic :host .switch-label>span.active{color:#fff}.nb-theme-cosmic :host .switch-label>span:active{opacity:0.78}.nb-theme-cosmic :host .switch{position:relative;display:inline-block;width:3rem;height:1.5rem;margin:0}.nb-theme-cosmic :host .switch input{display:none}[dir=ltr] .nb-theme-cosmic :host .switch input:checked+.slider::before{-webkit-transform:translateX(1.5rem);transform:translateX(1.5rem)}[dir=rtl] .nb-theme-cosmic :host .switch input:checked+.slider::before{-webkit-transform:translateX(-1.5rem);transform:translateX(-1.5rem)}.nb-theme-cosmic :host .switch .slider{position:absolute;top:0;left:0;right:0;bottom:0;border-radius:1.75rem;background-color:#2f296b}.nb-theme-cosmic :host .switch .slider::before{position:absolute;content:'';height:1.5rem;width:1.5rem;border-radius:50%;background-color:#00d977;-webkit-transition:0.2s;transition:0.2s;-webkit-box-shadow:0 0 0.25rem 0 rgba(161,161,229,0.4);box-shadow:0 0 0.25rem 0 rgba(161,161,229,0.4);background-image:-webkit-gradient(linear, left top, right top, from(#ad59ff), to(#7659ff));background-image:linear-gradient(to right, #ad59ff, #7659ff)}@media (max-width: 399.98px){.nb-theme-cosmic :host{-webkit-box-align:end;-ms-flex-align:end;align-items:flex-end}}.nb-theme-corporate :host .switch-label{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-ms-flex-align:center;align-items:center;cursor:pointer;margin:0}.nb-theme-corporate :host .switch-label.vertical{-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:start;-ms-flex-align:start;align-items:flex-start}.nb-theme-corporate :host .switch-label.vertical .first,.nb-theme-corporate :host .switch-label.vertical .second{padding:0}.nb-theme-corporate :host .switch-label.vertical .switch{margin-top:0.5em}.nb-theme-corporate :host .switch-label>span{font-size:1.125rem;font-weight:600;-webkit-transition:opacity 0.3s ease;transition:opacity 0.3s ease;color:#a4abb3}[dir=ltr] .nb-theme-corporate :host .switch-label>span.first{padding-right:10px}[dir=rtl] .nb-theme-corporate :host .switch-label>span.first{padding-left:10px}[dir=ltr] .nb-theme-corporate :host .switch-label>span.second{padding-left:10px}[dir=rtl] .nb-theme-corporate :host .switch-label>span.second{padding-right:10px}.nb-theme-corporate :host .switch-label>span.active{color:#4b4b4b}.nb-theme-corporate :host .switch-label>span:active{opacity:0.78}.nb-theme-corporate :host .switch{position:relative;display:inline-block;width:3rem;height:1.5rem;margin:0}.nb-theme-corporate :host .switch input{display:none}[dir=ltr] .nb-theme-corporate :host .switch input:checked+.slider::before{-webkit-transform:translateX(1.5rem);transform:translateX(1.5rem)}[dir=rtl] .nb-theme-corporate :host .switch input:checked+.slider::before{-webkit-transform:translateX(-1.5rem);transform:translateX(-1.5rem)}.nb-theme-corporate :host .switch .slider{position:absolute;top:0;left:0;right:0;bottom:0;border-radius:1.75rem;background-color:#f1f5f8}.nb-theme-corporate :host .switch .slider::before{position:absolute;content:'';height:1.5rem;width:1.5rem;border-radius:50%;background-color:#5dcfe3;-webkit-transition:0.2s;transition:0.2s;-webkit-box-shadow:0 0 0.25rem 0 rgba(164,171,179,0.4);box-shadow:0 0 0.25rem 0 rgba(164,171,179,0.4);background-color:#73a1ff}@media (max-width: 399.98px){.nb-theme-corporate :host{-webkit-box-align:end;-ms-flex-align:end;align-items:flex-end}}\n"
...
module.exports = ".nb-theme-default :host h6{margin-bottom:0.5rem}.nb-theme-default :host .settings-row{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-ms-flex-wrap:wrap;flex-wrap:wrap;width:90%;margin:0 0 1rem}.nb-theme-default :host .settings-row a{text-decoration:none;font-size:2.25rem;color:#a4abb3}.nb-theme-default :host .settings-row a.selected{color:#40dc7e}.nb-theme-default :host .settings{margin-bottom:1em}.nb-theme-default :host .switcher{margin-bottom:1rem}.nb-theme-default :host .switcher /deep/ ngx-switcher .switch-label span{font-size:1em;font-weight:normal}.nb-theme-default :host .switcher /deep/ ngx-switcher .switch{height:1.5em;width:3em}.nb-theme-default :host .switcher /deep/ ngx-switcher .switch .slider::before{height:1.5em;width:1.5em}[dir=ltr] .nb-theme-default :host .switcher /deep/ ngx-switcher .switch input:checked+.slider::before{-webkit-transform:translateX(1.5rem) !important;transform:translateX(1.5rem) !important}[dir=rtl] .nb-theme-default :host .switcher /deep/ ngx-switcher .switch input:checked+.slider::before{-webkit-transform:translateX(-1.5rem) !important;transform:translateX(-1.5rem) !important}.nb-theme-cosmic :host h6{margin-bottom:0.5rem}.nb-theme-cosmic :host .settings-row{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-ms-flex-wrap:wrap;flex-wrap:wrap;width:90%;margin:0 0 1rem}.nb-theme-cosmic :host .settings-row a{text-decoration:none;font-size:2.25rem;color:#a1a1e5}.nb-theme-cosmic :host .settings-row a.selected{color:#00d977}.nb-theme-cosmic :host .settings-row a.selected{color:#00f9a6}.nb-theme-cosmic :host .settings{margin-bottom:1em}.nb-theme-cosmic :host .switcher{margin-bottom:1rem}.nb-theme-cosmic :host .switcher /deep/ ngx-switcher .switch-label span{font-size:1em;font-weight:normal}.nb-theme-cosmic :host .switcher /deep/ ngx-switcher .switch{height:1.5em;width:3em}.nb-theme-cosmic :host .switcher /deep/ ngx-switcher .switch .slider::before{height:1.5em;width:1.5em}[dir=ltr] .nb-theme-cosmic :host .switcher /deep/ ngx-switcher .switch input:checked+.slider::before{-webkit-transform:translateX(1.5rem) !important;transform:translateX(1.5rem) !important}[dir=rtl] .nb-theme-cosmic :host .switcher /deep/ ngx-switcher .switch input:checked+.slider::before{-webkit-transform:translateX(-1.5rem) !important;transform:translateX(-1.5rem) !important}.nb-theme-cosmic :host .switcher /deep/ ngx-switcher .switch .slider{background-color:#3d3780}.nb-theme-corporate :host h6{margin-bottom:0.5rem}.nb-theme-corporate :host .settings-row{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-ms-flex-wrap:wrap;flex-wrap:wrap;width:90%;margin:0 0 1rem}.nb-theme-corporate :host .settings-row a{text-decoration:none;font-size:2.25rem;color:#a4abb3}.nb-theme-corporate :host .settings-row a.selected{color:#5dcfe3}.nb-theme-corporate :host .settings{margin-bottom:1em}.nb-theme-corporate :host .switcher{margin-bottom:1rem}.nb-theme-corporate :host .switcher /deep/ ngx-switcher .switch-label span{font-size:1em;font-weight:normal}.nb-theme-corporate :host .switcher /deep/ ngx-switcher .switch{height:1.5em;width:3em}.nb-theme-corporate :host .switcher /deep/ ngx-switcher .switch .slider::before{height:1.5em;width:1.5em}[dir=ltr] .nb-theme-corporate :host .switcher /deep/ ngx-switcher .switch input:checked+.slider::before{-webkit-transform:translateX(1.5rem) !important;transform:translateX(1.5rem) !important}[dir=rtl] .nb-theme-corporate :host .switcher /deep/ ngx-switcher .switch input:checked+.slider::before{-webkit-transform:translateX(-1.5rem) !important;transform:translateX(-1.5rem) !important}\n"
...
module.exports = ".nb-theme-default :host .themes-switcher{display:-webkit-box;display:-ms-flexbox;display:flex;font-size:1.25rem;padding:0.8rem 1.25rem;-webkit-box-align:center;-ms-flex-align:center;align-items:center;cursor:pointer;background-color:#ebeff5;border-radius:.375rem}.nb-theme-default :host .themes-switcher:hover{background-color:#f5f7fa}.nb-theme-default :host .themes-switcher span{margin:0 1.2rem}.nb-theme-default :host .themes-switcher i{color:#8a7fff;font-size:1.8rem;border-radius:50%;position:relative;color:#40dc7e}.nb-theme-default :host .themes-switcher i::before{background:-webkit-linear-gradient(#01dbb5, #0bbb79);-webkit-background-clip:text;-webkit-text-fill-color:transparent}.nb-theme-cosmic :host .themes-switcher{display:-webkit-box;display:-ms-flexbox;display:flex;font-size:1.25rem;padding:0.8rem 1.25rem;-webkit-box-align:center;-ms-flex-align:center;align-items:center;cursor:pointer;background-color:#4e41a5;border-radius:.5rem}.nb-theme-cosmic :host .themes-switcher:hover{background-color:#675cb2}.nb-theme-cosmic :host .themes-switcher span{margin:0 1.2rem}.nb-theme-cosmic :host .themes-switcher i{color:#7659ff;font-size:1.8rem;border-radius:50%;position:relative}.nb-theme-cosmic :host .themes-switcher i::before{background:-webkit-linear-gradient(#a258fe, #7958fa);-webkit-background-clip:text;-webkit-text-fill-color:transparent}.nb-theme-corporate :host .themes-switcher{display:-webkit-box;display:-ms-flexbox;display:flex;font-size:1.25rem;padding:0.8rem 1.25rem;-webkit-box-align:center;-ms-flex-align:center;align-items:center;cursor:pointer;background-color:#2b2d34;border-radius:.17rem}.nb-theme-corporate :host .themes-switcher:hover{background-color:#494a50}.nb-theme-corporate :host .themes-switcher span{margin:0 1.2rem}.nb-theme-corporate :host .themes-switcher i{color:#73a1ff;font-size:1.8rem;border-radius:50%;position:relative;color:#a4abb3}.nb-theme-corporate :host .themes-switcher i::before{background:-webkit-linear-gradient(#e9e8eb, #a7a2be);-webkit-background-clip:text;-webkit-text-fill-color:transparent}\n"
...
module.exports = ".nb-theme-default :host /deep/ .themes-switcher-list{padding:1rem 2rem 1.25rem 0.5rem;margin:0}[dir=ltr] .nb-theme-default :host /deep/ .themes-switcher-list{text-align:start}[dir=rtl] .nb-theme-default :host /deep/ .themes-switcher-list{text-align:end}.nb-theme-default :host /deep/ .themes-switcher-list .themes-switcher-item{list-style:none;cursor:pointer}.nb-theme-default :host /deep/ .themes-switcher-list .themes-switcher-item:hover span{opacity:0.5}.nb-theme-default :host /deep/ .themes-switcher-list .themes-switcher-item i{font-size:2rem}.nb-theme-default :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-default{color:#0bbb79;background:-webkit-linear-gradient(#01dbb5, #0bbb79)}.nb-theme-default :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-cosmic{color:#7958fa;background:-webkit-linear-gradient(#a258fe, #7958fa)}.nb-theme-default :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-corporate{color:#a7a2be;background:-webkit-linear-gradient(#e9e8eb, #a7a2be)}.nb-theme-default :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-default,.nb-theme-default :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-cosmic,.nb-theme-default :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-corporate{-webkit-background-clip:text;-webkit-text-fill-color:transparent}.nb-theme-default :host /deep/ .themes-switcher-list .themes-switcher-item span{font-weight:300;vertical-align:super;padding-left:1rem;color:#2a2a2a}@media (max-width: 575.98px){.nb-theme-default :host /deep/ .themes-switcher-list{display:none}}.nb-theme-cosmic :host /deep/ .themes-switcher-list{padding:1rem 2rem 1.25rem 0.5rem;margin:0}[dir=ltr] .nb-theme-cosmic :host /deep/ .themes-switcher-list{text-align:start}[dir=rtl] .nb-theme-cosmic :host /deep/ .themes-switcher-list{text-align:end}.nb-theme-cosmic :host /deep/ .themes-switcher-list .themes-switcher-item{list-style:none;cursor:pointer}.nb-theme-cosmic :host /deep/ .themes-switcher-list .themes-switcher-item:hover span{opacity:0.5}.nb-theme-cosmic :host /deep/ .themes-switcher-list .themes-switcher-item i{font-size:2rem}.nb-theme-cosmic :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-default{color:#0bbb79;background:-webkit-linear-gradient(#01dbb5, #0bbb79)}.nb-theme-cosmic :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-cosmic{color:#7958fa;background:-webkit-linear-gradient(#a258fe, #7958fa)}.nb-theme-cosmic :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-corporate{color:#a7a2be;background:-webkit-linear-gradient(#e9e8eb, #a7a2be)}.nb-theme-cosmic :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-default,.nb-theme-cosmic :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-cosmic,.nb-theme-cosmic :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-corporate{-webkit-background-clip:text;-webkit-text-fill-color:transparent}.nb-theme-cosmic :host /deep/ .themes-switcher-list .themes-switcher-item span{font-weight:300;vertical-align:super;padding-left:1rem;color:#fff}@media (max-width: 575.98px){.nb-theme-cosmic :host /deep/ .themes-switcher-list{display:none}}.nb-theme-corporate :host /deep/ .themes-switcher-list{padding:1rem 2rem 1.25rem 0.5rem;margin:0}[dir=ltr] .nb-theme-corporate :host /deep/ .themes-switcher-list{text-align:start}[dir=rtl] .nb-theme-corporate :host /deep/ .themes-switcher-list{text-align:end}.nb-theme-corporate :host /deep/ .themes-switcher-list .themes-switcher-item{list-style:none;cursor:pointer}.nb-theme-corporate :host /deep/ .themes-switcher-list .themes-switcher-item:hover span{opacity:0.5}.nb-theme-corporate :host /deep/ .themes-switcher-list .themes-switcher-item i{font-size:2rem}.nb-theme-corporate :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-default{color:#0bbb79;background:-webkit-linear-gradient(#01dbb5, #0bbb79)}.nb-theme-corporate :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-cosmic{color:#7958fa;background:-webkit-linear-gradient(#a258fe, #7958fa)}.nb-theme-corporate :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-corporate{color:#a7a2be;background:-webkit-linear-gradient(#e9e8eb, #a7a2be)}.nb-theme-corporate :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-default,.nb-theme-corporate :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-cosmic,.nb-theme-corporate :host /deep/ .themes-switcher-list .themes-switcher-item i.drop-icon-corporate{-webkit-background-clip:text;-webkit-text-fill-color:transparent}.nb-theme-corporate :host /deep/ .themes-switcher-list .themes-switcher-item span{font-weight:300;vertical-align:super;padding-left:1rem;color:#181818}@media (max-width: 575.98px){.nb-theme-corporate :host /deep/ .themes-switcher-list{display:none}}\n"
...
module.exports = ".nb-theme-default :host nb-layout-column.small{-webkit-box-flex:0.15 !important;-ms-flex:0.15 !important;flex:0.15 !important}.nb-theme-default :host nb-sidebar.settings-sidebar{-webkit-transition:width 0.3s ease;transition:width 0.3s ease;width:15rem;overflow:hidden}.nb-theme-default :host nb-sidebar.settings-sidebar.collapsed{width:0}.nb-theme-default :host nb-sidebar.settings-sidebar.collapsed /deep/ .main-container{width:0}.nb-theme-default :host nb-sidebar.settings-sidebar.collapsed /deep/ .main-container .scrollable{width:15rem;padding:1.25rem}.nb-theme-default :host nb-sidebar.settings-sidebar /deep/ .main-container{width:15rem;background:#fff;-webkit-transition:width 0.3s ease;transition:width 0.3s ease;overflow:hidden}.nb-theme-default :host nb-sidebar.settings-sidebar /deep/ .main-container .scrollable{width:15rem}.nb-theme-default :host nb-sidebar.menu-sidebar{margin-top:2rem;background:transparent}.nb-theme-default :host nb-sidebar.menu-sidebar /deep/ .main-container{height:calc(100vh - 4.75rem - 2rem) !important}[dir=ltr] .nb-theme-default :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-right-radius:.375rem}[dir=rtl] .nb-theme-default :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-left-radius:.375rem}.nb-theme-default :host nb-sidebar.menu-sidebar /deep/ nb-sidebar-header{padding-bottom:0.5rem;text-align:center}.nb-theme-default :host nb-sidebar.menu-sidebar .main-btn{padding:0.75rem 2.5rem;margin-top:-2rem;font-weight:bold;-webkit-transition:padding 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.48);transition:padding 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.48)}.nb-theme-default :host nb-sidebar.menu-sidebar .main-btn i{font-size:2rem;text-shadow:0 1px 1px rgba(0,0,0,0.2)}[dir=ltr] .nb-theme-default :host nb-sidebar.menu-sidebar .main-btn span{padding-left:.25rem}[dir=rtl] .nb-theme-default :host nb-sidebar.menu-sidebar .main-btn span{padding-right:.25rem}.nb-theme-default :host nb-sidebar.menu-sidebar .main-btn i,.nb-theme-default :host nb-sidebar.menu-sidebar .main-btn span{vertical-align:middle}.nb-theme-default :host nb-sidebar.menu-sidebar.compacted /deep/ nb-sidebar-header{padding-left:0;padding-right:0}.nb-theme-default :host nb-sidebar.menu-sidebar.compacted .main-btn{width:46px;height:44px;padding:0.375rem;border-radius:5px;-webkit-transition:none;transition:none}.nb-theme-default :host nb-sidebar.menu-sidebar.compacted .main-btn span{display:none}@media (max-width: 399.98px){.nb-theme-default :host .main-content{padding:0.75rem !important}}@media (max-width: 767.98px){.nb-theme-default :host nb-sidebar.menu-sidebar{margin-top:0}.nb-theme-default :host nb-sidebar.menu-sidebar /deep/ .main-container{height:calc(100vh - 4.75rem) !important}[dir=ltr] .nb-theme-default :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-right-radius:0}[dir=rtl] .nb-theme-default :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-left-radius:0}.nb-theme-default :host nb-sidebar.menu-sidebar /deep/ .main-container .scrollable{padding-top:0}.nb-theme-default :host .main-btn{display:none}}.nb-theme-cosmic :host nb-layout-column.small{-webkit-box-flex:0.15 !important;-ms-flex:0.15 !important;flex:0.15 !important}.nb-theme-cosmic :host nb-sidebar.settings-sidebar{-webkit-transition:width 0.3s ease;transition:width 0.3s ease;width:15rem;overflow:hidden}.nb-theme-cosmic :host nb-sidebar.settings-sidebar.collapsed{width:0}.nb-theme-cosmic :host nb-sidebar.settings-sidebar.collapsed /deep/ .main-container{width:0}.nb-theme-cosmic :host nb-sidebar.settings-sidebar.collapsed /deep/ .main-container .scrollable{width:15rem;padding:1.25rem}.nb-theme-cosmic :host nb-sidebar.settings-sidebar /deep/ .main-container{width:15rem;background:#3d3780;-webkit-transition:width 0.3s ease;transition:width 0.3s ease;overflow:hidden;background:#2f296b}.nb-theme-cosmic :host nb-sidebar.settings-sidebar /deep/ .main-container .scrollable{width:15rem}.nb-theme-cosmic :host nb-sidebar.menu-sidebar{margin-top:2rem;background:transparent}.nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ .main-container{height:calc(100vh - 4.75rem - 2rem) !important}[dir=ltr] .nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-right-radius:.5rem}[dir=rtl] .nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-left-radius:.5rem}.nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ nb-sidebar-header{padding-bottom:0.5rem;text-align:center}.nb-theme-cosmic :host nb-sidebar.menu-sidebar .main-btn{padding:0.75rem 2.5rem;margin-top:-2rem;font-weight:bold;-webkit-transition:padding 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.48);transition:padding 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.48)}.nb-theme-cosmic :host nb-sidebar.menu-sidebar .main-btn i{font-size:2rem;text-shadow:0 1px 1px rgba(0,0,0,0.2)}[dir=ltr] .nb-theme-cosmic :host nb-sidebar.menu-sidebar .main-btn span{padding-left:.25rem}[dir=rtl] .nb-theme-cosmic :host nb-sidebar.menu-sidebar .main-btn span{padding-right:.25rem}.nb-theme-cosmic :host nb-sidebar.menu-sidebar .main-btn i,.nb-theme-cosmic :host nb-sidebar.menu-sidebar .main-btn span{vertical-align:middle}.nb-theme-cosmic :host nb-sidebar.menu-sidebar.compacted /deep/ nb-sidebar-header{padding-left:0;padding-right:0}.nb-theme-cosmic :host nb-sidebar.menu-sidebar.compacted .main-btn{width:46px;height:44px;padding:0.375rem;border-radius:5px;-webkit-transition:none;transition:none}.nb-theme-cosmic :host nb-sidebar.menu-sidebar.compacted .main-btn span{display:none}@media (max-width: 399.98px){.nb-theme-cosmic :host .main-content{padding:0.75rem !important}}@media (max-width: 767.98px){.nb-theme-cosmic :host nb-sidebar.menu-sidebar{margin-top:0}.nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ .main-container{height:calc(100vh - 4.75rem) !important}[dir=ltr] .nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-right-radius:0}[dir=rtl] .nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-left-radius:0}.nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ .main-container .scrollable{padding-top:0}.nb-theme-cosmic :host .main-btn{display:none}}.nb-theme-corporate :host nb-layout-column.small{-webkit-box-flex:0.15 !important;-ms-flex:0.15 !important;flex:0.15 !important}.nb-theme-corporate :host nb-sidebar.settings-sidebar{-webkit-transition:width 0.3s ease;transition:width 0.3s ease;width:15rem;overflow:hidden}.nb-theme-corporate :host nb-sidebar.settings-sidebar.collapsed{width:0}.nb-theme-corporate :host nb-sidebar.settings-sidebar.collapsed /deep/ .main-container{width:0}.nb-theme-corporate :host nb-sidebar.settings-sidebar.collapsed /deep/ .main-container .scrollable{width:15rem;padding:1.25rem}.nb-theme-corporate :host nb-sidebar.settings-sidebar /deep/ .main-container{width:15rem;background:#fff;-webkit-transition:width 0.3s ease;transition:width 0.3s ease;overflow:hidden}.nb-theme-corporate :host nb-sidebar.settings-sidebar /deep/ .main-container .scrollable{width:15rem}.nb-theme-corporate :host nb-sidebar.menu-sidebar{margin-top:2rem;margin-top:0;background:transparent}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .main-container{height:calc(100vh - 4.75rem - 2rem) !important;border:1px solid #cdd5dc;height:calc(100vh - 4.75rem) !important}[dir=ltr] .nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-right-radius:.17rem}[dir=rtl] .nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-left-radius:.17rem}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .scrollable{padding-top:0}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .scrollable .menu-item:first-child{border-top:none}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ nb-sidebar-header{padding-bottom:0.5rem;text-align:center}.nb-theme-corporate :host nb-sidebar.menu-sidebar .main-btn{padding:0.75rem 2.5rem;margin-top:-2rem;font-weight:bold;-webkit-transition:padding 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.48);transition:padding 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.48);border-radius:.17rem}.nb-theme-corporate :host nb-sidebar.menu-sidebar .main-btn i{font-size:2rem;text-shadow:0 1px 1px rgba(0,0,0,0.2)}[dir=ltr] .nb-theme-corporate :host nb-sidebar.menu-sidebar .main-btn span{padding-left:.25rem}[dir=rtl] .nb-theme-corporate :host nb-sidebar.menu-sidebar .main-btn span{padding-right:.25rem}.nb-theme-corporate :host nb-sidebar.menu-sidebar .main-btn i,.nb-theme-corporate :host nb-sidebar.menu-sidebar .main-btn span{vertical-align:middle}.nb-theme-corporate :host nb-sidebar.menu-sidebar.compacted /deep/ nb-sidebar-header{padding-left:0;padding-right:0}.nb-theme-corporate :host nb-sidebar.menu-sidebar.compacted .main-btn{width:46px;height:44px;padding:0.375rem;border-radius:5px;-webkit-transition:none;transition:none}.nb-theme-corporate :host nb-sidebar.menu-sidebar.compacted .main-btn span{display:none}@media (max-width: 399.98px){.nb-theme-corporate :host .main-content{padding:0.75rem !important}}@media (max-width: 767.98px){.nb-theme-corporate :host nb-sidebar.menu-sidebar{margin-top:0}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .main-container{height:calc(100vh - 4.75rem) !important}[dir=ltr] .nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-right-radius:0}[dir=rtl] .nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-left-radius:0}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .main-container .scrollable{padding-top:0}.nb-theme-corporate :host .main-btn{display:none}}\n"
...
module.exports = ".nb-theme-default :host nb-layout-column.small{-webkit-box-flex:0.15 !important;-ms-flex:0.15 !important;flex:0.15 !important}.nb-theme-default :host nb-sidebar.settings-sidebar{-webkit-transition:width 0.3s ease;transition:width 0.3s ease;width:15rem;overflow:hidden}.nb-theme-default :host nb-sidebar.settings-sidebar.collapsed{width:0}.nb-theme-default :host nb-sidebar.settings-sidebar.collapsed /deep/ .main-container{width:0}.nb-theme-default :host nb-sidebar.settings-sidebar.collapsed /deep/ .main-container .scrollable{width:15rem;padding:1.25rem}.nb-theme-default :host nb-sidebar.settings-sidebar /deep/ .main-container{width:15rem;background:#fff;-webkit-transition:width 0.3s ease;transition:width 0.3s ease;overflow:hidden}.nb-theme-default :host nb-sidebar.settings-sidebar /deep/ .main-container .scrollable{width:15rem}.nb-theme-default :host .menu-title{width:5rem}.nb-theme-default :host nb-sidebar.menu-sidebar{margin-top:2rem;width:8rem;background:transparent}.nb-theme-default :host nb-sidebar.menu-sidebar /deep/ .main-container{height:calc(100vh - 4.75rem - 2rem) !important}[dir=ltr] .nb-theme-default :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-right-radius:.375rem}[dir=rtl] .nb-theme-default :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-left-radius:.375rem}.nb-theme-default :host nb-sidebar.menu-sidebar /deep/ nb-sidebar-header{padding-bottom:0.5rem;text-align:center}.nb-theme-default :host nb-sidebar.menu-sidebar .main-btn{padding:0.75rem 2.5rem;margin-top:-2rem;font-weight:bold;-webkit-transition:padding 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.48);transition:padding 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.48)}.nb-theme-default :host nb-sidebar.menu-sidebar .main-btn i{font-size:2rem;text-shadow:0 1px 1px rgba(0,0,0,0.2)}[dir=ltr] .nb-theme-default :host nb-sidebar.menu-sidebar .main-btn span{padding-left:.25rem}[dir=rtl] .nb-theme-default :host nb-sidebar.menu-sidebar .main-btn span{padding-right:.25rem}.nb-theme-default :host nb-sidebar.menu-sidebar .main-btn i,.nb-theme-default :host nb-sidebar.menu-sidebar .main-btn span{vertical-align:middle}.nb-theme-default :host nb-sidebar.menu-sidebar /deep/ nb-menu>.menu-items>.menu-item:first-child .menu-title::after{color:#fff;margin-left:1rem;background:#ff4c6a;padding:0 0.5rem;border-radius:.375rem;font-size:.875rem}.nb-theme-default :host nb-sidebar.menu-sidebar /deep/ nb-menu>.menu-items>.menu-item .active{background-color:#ffeebc !important}.nb-theme-default :host nb-sidebar.menu-sidebar /deep/ nb-menu .nb-e-commerce{font-size:2rem}.nb-theme-default :host nb-sidebar.menu-sidebar.compacted /deep/ nb-sidebar-header{padding-left:0;padding-right:0}.nb-theme-default :host nb-sidebar.menu-sidebar.compacted .main-btn{width:46px;height:44px;padding:0.375rem;border-radius:5px;-webkit-transition:none;transition:none}.nb-theme-default :host nb-sidebar.menu-sidebar.compacted .main-btn span{display:none}@media (max-width: 399.98px){.nb-theme-default :host .main-content{padding:0.75rem !important}}@media (max-width: 767.98px){.nb-theme-default :host nb-sidebar.menu-sidebar{margin-top:0}.nb-theme-default :host nb-sidebar.menu-sidebar /deep/ .main-container{height:calc(100vh - 4.75rem) !important}[dir=ltr] .nb-theme-default :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-right-radius:0}[dir=rtl] .nb-theme-default :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-left-radius:0}.nb-theme-default :host nb-sidebar.menu-sidebar /deep/ .main-container .scrollable{padding-top:0}.nb-theme-default :host .main-btn{display:none}}.nb-theme-cosmic :host nb-layout-column.small{-webkit-box-flex:0.15 !important;-ms-flex:0.15 !important;flex:0.15 !important}.nb-theme-cosmic :host nb-sidebar.settings-sidebar{-webkit-transition:width 0.3s ease;transition:width 0.3s ease;width:15rem;overflow:hidden}.nb-theme-cosmic :host nb-sidebar.settings-sidebar.collapsed{width:0}.nb-theme-cosmic :host nb-sidebar.settings-sidebar.collapsed /deep/ .main-container{width:0}.nb-theme-cosmic :host nb-sidebar.settings-sidebar.collapsed /deep/ .main-container .scrollable{width:15rem;padding:1.25rem}.nb-theme-cosmic :host nb-sidebar.settings-sidebar /deep/ .main-container{width:15rem;background:#3d3780;-webkit-transition:width 0.3s ease;transition:width 0.3s ease;overflow:hidden;background:#2f296b}.nb-theme-cosmic :host nb-sidebar.settings-sidebar /deep/ .main-container .scrollable{width:15rem}.nb-theme-cosmic :host .menu-title{width:5rem}.nb-theme-cosmic :host nb-sidebar.menu-sidebar{margin-top:2rem;width:8rem;background:transparent}.nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ .main-container{height:calc(100vh - 4.75rem - 2rem) !important}[dir=ltr] .nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-right-radius:.5rem}[dir=rtl] .nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-left-radius:.5rem}.nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ nb-sidebar-header{padding-bottom:0.5rem;text-align:center}.nb-theme-cosmic :host nb-sidebar.menu-sidebar .main-btn{padding:0.75rem 2.5rem;margin-top:-2rem;font-weight:bold;-webkit-transition:padding 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.48);transition:padding 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.48)}.nb-theme-cosmic :host nb-sidebar.menu-sidebar .main-btn i{font-size:2rem;text-shadow:0 1px 1px rgba(0,0,0,0.2)}[dir=ltr] .nb-theme-cosmic :host nb-sidebar.menu-sidebar .main-btn span{padding-left:.25rem}[dir=rtl] .nb-theme-cosmic :host nb-sidebar.menu-sidebar .main-btn span{padding-right:.25rem}.nb-theme-cosmic :host nb-sidebar.menu-sidebar .main-btn i,.nb-theme-cosmic :host nb-sidebar.menu-sidebar .main-btn span{vertical-align:middle}.nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ nb-menu>.menu-items>.menu-item:first-child .menu-title::after{color:#fff;margin-left:1rem;background:#ff386a;padding:0 0.5rem;border-radius:.5rem;font-size:.875rem}.nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ nb-menu>.menu-items>.menu-item .active{background-color:#ffeebc !important}.nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ nb-menu .nb-e-commerce{font-size:2rem}.nb-theme-cosmic :host nb-sidebar.menu-sidebar.compacted /deep/ nb-sidebar-header{padding-left:0;padding-right:0}.nb-theme-cosmic :host nb-sidebar.menu-sidebar.compacted .main-btn{width:46px;height:44px;padding:0.375rem;border-radius:5px;-webkit-transition:none;transition:none}.nb-theme-cosmic :host nb-sidebar.menu-sidebar.compacted .main-btn span{display:none}@media (max-width: 399.98px){.nb-theme-cosmic :host .main-content{padding:0.75rem !important}}@media (max-width: 767.98px){.nb-theme-cosmic :host nb-sidebar.menu-sidebar{margin-top:0}.nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ .main-container{height:calc(100vh - 4.75rem) !important}[dir=ltr] .nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-right-radius:0}[dir=rtl] .nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-left-radius:0}.nb-theme-cosmic :host nb-sidebar.menu-sidebar /deep/ .main-container .scrollable{padding-top:0}.nb-theme-cosmic :host .main-btn{display:none}}.nb-theme-corporate :host nb-layout-column.small{-webkit-box-flex:0.15 !important;-ms-flex:0.15 !important;flex:0.15 !important}.nb-theme-corporate :host nb-sidebar.settings-sidebar{-webkit-transition:width 0.3s ease;transition:width 0.3s ease;width:15rem;overflow:hidden}.nb-theme-corporate :host nb-sidebar.settings-sidebar.collapsed{width:0}.nb-theme-corporate :host nb-sidebar.settings-sidebar.collapsed /deep/ .main-container{width:0}.nb-theme-corporate :host nb-sidebar.settings-sidebar.collapsed /deep/ .main-container .scrollable{width:15rem;padding:1.25rem}.nb-theme-corporate :host nb-sidebar.settings-sidebar /deep/ .main-container{width:15rem;background:#fff;-webkit-transition:width 0.3s ease;transition:width 0.3s ease;overflow:hidden}.nb-theme-corporate :host nb-sidebar.settings-sidebar /deep/ .main-container .scrollable{width:15rem}.nb-theme-corporate :host .menu-title{width:5rem}.nb-theme-corporate :host nb-sidebar.menu-sidebar{margin-top:2rem;width:8rem;margin-top:0;background:transparent}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .main-container{height:calc(100vh - 4.75rem - 2rem) !important;border:1px solid #cdd5dc;height:calc(100vh - 4.75rem) !important}[dir=ltr] .nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-right-radius:.17rem}[dir=rtl] .nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-left-radius:.17rem}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .scrollable{padding-top:0}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .scrollable .menu-item:first-child{border-top:none}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ nb-sidebar-header{padding-bottom:0.5rem;text-align:center}.nb-theme-corporate :host nb-sidebar.menu-sidebar .main-btn{padding:0.75rem 2.5rem;margin-top:-2rem;font-weight:bold;-webkit-transition:padding 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.48);transition:padding 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.48);border-radius:.17rem}.nb-theme-corporate :host nb-sidebar.menu-sidebar .main-btn i{font-size:2rem;text-shadow:0 1px 1px rgba(0,0,0,0.2)}[dir=ltr] .nb-theme-corporate :host nb-sidebar.menu-sidebar .main-btn span{padding-left:.25rem}[dir=rtl] .nb-theme-corporate :host nb-sidebar.menu-sidebar .main-btn span{padding-right:.25rem}.nb-theme-corporate :host nb-sidebar.menu-sidebar .main-btn i,.nb-theme-corporate :host nb-sidebar.menu-sidebar .main-btn span{vertical-align:middle}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ nb-menu>.menu-items>.menu-item:first-child .menu-title::after{color:#fff;margin-left:1rem;background:#ff6b83;padding:0 0.5rem;border-radius:.17rem;font-size:.875rem}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ nb-menu>.menu-items>.menu-item .active{background-color:#ffeebc !important}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ nb-menu .nb-e-commerce{font-size:2rem}.nb-theme-corporate :host nb-sidebar.menu-sidebar.compacted /deep/ nb-sidebar-header{padding-left:0;padding-right:0}.nb-theme-corporate :host nb-sidebar.menu-sidebar.compacted .main-btn{width:46px;height:44px;padding:0.375rem;border-radius:5px;-webkit-transition:none;transition:none}.nb-theme-corporate :host nb-sidebar.menu-sidebar.compacted .main-btn span{display:none}@media (max-width: 399.98px){.nb-theme-corporate :host .main-content{padding:0.75rem !important}}@media (max-width: 767.98px){.nb-theme-corporate :host nb-sidebar.menu-sidebar{margin-top:0}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .main-container{height:calc(100vh - 4.75rem) !important}[dir=ltr] .nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-right-radius:0}[dir=rtl] .nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .main-container{border-top-left-radius:0}.nb-theme-corporate :host nb-sidebar.menu-sidebar /deep/ .main-container .scrollable{padding-top:0}.nb-theme-corporate :host .main-btn{display:none}}\n"
...
/* harmony import */ var _google_places_directive__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./google-places.directive */ "./src/app/google-places.directive.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_6__["AppComponent"], _google_places_directive__WEBPACK_IMPORTED_MODULE_10__["GooglePlacesDirective"]],
            imports: [
