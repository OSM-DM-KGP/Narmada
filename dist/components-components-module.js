...
module.exports = ".nb-theme-default :host nb-card-footer{padding-bottom:0.25rem}[dir=ltr] .nb-theme-default :host nb-card-footer button{margin:0 1rem 1rem 0}[dir=rtl] .nb-theme-default :host nb-card-footer button{margin:0 0 1rem 1rem}.nb-theme-default :host toaster-container /deep/ #toast-container .toast-close-button{right:0}@media (max-width: 399.98px){.nb-theme-default :host .dropdown-toggle{font-size:0.75rem}}.nb-theme-cosmic :host nb-card-footer{padding-bottom:0.25rem}[dir=ltr] .nb-theme-cosmic :host nb-card-footer button{margin:0 1rem 1rem 0}[dir=rtl] .nb-theme-cosmic :host nb-card-footer button{margin:0 0 1rem 1rem}.nb-theme-cosmic :host toaster-container /deep/ #toast-container .toast-close-button{right:0}@media (max-width: 399.98px){.nb-theme-cosmic :host .dropdown-toggle{font-size:0.75rem}}.nb-theme-corporate :host nb-card-footer{padding-bottom:0.25rem}[dir=ltr] .nb-theme-corporate :host nb-card-footer button{margin:0 1rem 1rem 0}[dir=rtl] .nb-theme-corporate :host nb-card-footer button{margin:0 0 1rem 1rem}.nb-theme-corporate :host toaster-container /deep/ #toast-container .toast-close-button{right:0}@media (max-width: 399.98px){.nb-theme-corporate :host .dropdown-toggle{font-size:0.75rem}}\n"
...
module.exports = ".nb-theme-default :host /deep/ .angular-tree-component{cursor:default}.nb-theme-default :host /deep/ .angular-tree-component .node-wrapper .node-content-wrapper{background:none;-webkit-box-shadow:none;box-shadow:none;cursor:default}.nb-theme-default :host /deep/ .angular-tree-component .node-wrapper .toggle-children-wrapper{cursor:pointer}.nb-theme-cosmic :host /deep/ .angular-tree-component{cursor:default}.nb-theme-cosmic :host /deep/ .angular-tree-component .node-wrapper .node-content-wrapper{background:none;-webkit-box-shadow:none;box-shadow:none;cursor:default}.nb-theme-cosmic :host /deep/ .angular-tree-component .node-wrapper .toggle-children-wrapper{cursor:pointer}.nb-theme-corporate :host /deep/ .angular-tree-component{cursor:default}.nb-theme-corporate :host /deep/ .angular-tree-component .node-wrapper .node-content-wrapper{background:none;-webkit-box-shadow:none;box-shadow:none;cursor:default}.nb-theme-corporate :host /deep/ .angular-tree-component .node-wrapper .toggle-children-wrapper{cursor:pointer}\n"
